...
class _MannersPageState extends State<MannersPage> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            //   child: const Text(
            //     'Everyday ethics and manners are important for the success of any relationship.',
            //     style: TextStyle(
            //       fontSize: 18,
            //       fontWeight: FontWeight.bold,
            ...
            // _buildManner(Icons.person, 'صدق (سچائی)'),
            // _buildManner(Icons.favorite, 'رحم دلی'),
            // _buildManner(Icons.family_restroom, 'والدین کی خدمت'),
            // _buildManner(Icons.handshake, 'پڑوسی حقوق'),
            // _buildManner(Icons.sanitizer, 'صفائی'),
  ...
  Widget _buildManner(IconData icon, String text) {
    return Card(
